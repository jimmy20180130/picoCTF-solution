...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (this.mOrientation == 1 && (majorGravity = this.mGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay) != 48) {
            if (majorGravity == 16) {
    ...
    */
    ...
    void layoutVertical(int left, int top, int right, int bottom) {
        ...
        int count = getVirtualChildCount();
        int i = this.mGravity;
        int majorGravity = i & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
    ...
    */
    ...
    public void setVerticalGravity(int verticalGravity) {
        int gravity = verticalGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
        int i = this.mGravity;
        if ((i & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay) != gravity) {
