...
public class SlidingPaneLayout extends ViewGroup {
  ...
  0x00be: PHI (r9v4 'weightSum' float) = (r9v3 'weightSum' float), (r9v11 'weightSum' float) binds: [B:35:0x00b1, B:37:0x00b8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    void onPanelDragged(int newLeft) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void parallaxOtherViews(float r12) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
            r11 = this;
    ...
    private class DragHelperCallback extends ViewDragHelper.Callback {
        ...
        @Override // androidx.customview.widget.ViewDragHelper.Callback
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
