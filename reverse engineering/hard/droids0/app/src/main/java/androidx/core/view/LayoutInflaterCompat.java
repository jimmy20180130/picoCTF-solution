...
public final class LayoutInflaterCompat {
    ...
    @Deprecated
    public static void setFactory(@NonNull LayoutInflater inflater, @NonNull LayoutInflaterFactory factory) throws IllegalAccessException, IllegalArgumentException {
    ...
    public static void setFactory2(@NonNull LayoutInflater inflater, @NonNull LayoutInflater.Factory2 factory) throws IllegalAccessException, IllegalArgumentException {
