...
public class Toolbar extends ViewGroup {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            lp.gravity = 8388613 | (this.mButtonGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams lp = generateDefaultLayoutParams();
            lp.gravity = 8388611 | (this.mButtonGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay);
    ...
    */
    ...
    private int getChildVerticalGravity(int gravity) {
        int vgrav = gravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (vgrav == 16 || vgrav == 48 || vgrav == 80) {
            return vgrav;
        }
        return this.mGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            if (expandedActionParent != toolbar3) {
                ...
                lp.gravity = 8388611 | (Toolbar.this.mButtonGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay);
                lp.mViewType = 2;
