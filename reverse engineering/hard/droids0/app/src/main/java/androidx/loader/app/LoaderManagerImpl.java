...
class LoaderManagerImpl extends LoaderManager {
    ...
    @NonNull
    @MainThread
    private <D> Loader<D> createAndInstallLoader(int id, @Nullable Bundle args, @NonNull LoaderManager.LoaderCallbacks<D> callback, @Nullable Loader<D> priorLoader) throws Throwable {
        try {
