...
class DocumentsContractApi19 {
    ...
    @Nullable
    private static String queryForString(Context context, Uri self, String column, @Nullable String defaultValue) throws Exception {
        ContentResolver resolver = context.getContentResolver();
        Cursor c = null;
        try {
    ...
    private static void closeQuietly(@Nullable AutoCloseable closeable) throws Exception {
        if (closeable != null) {
            try {
                closeable.close();
