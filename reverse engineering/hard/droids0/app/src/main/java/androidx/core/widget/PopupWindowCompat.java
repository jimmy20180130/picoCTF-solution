...
public final class PopupWindowCompat {
    ...
    public static void setOverlapAnchor(@NonNull PopupWindow popupWindow, boolean overlapAnchor) throws IllegalAccessException, IllegalArgumentException {
    ...
    public static void setWindowLayoutType(@NonNull PopupWindow popupWindow, int layoutType) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
