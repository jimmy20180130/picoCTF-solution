        ...
        while (i < size) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (lp2 == null || !lp2.isDecor) {
                    ...
                    int vgrav = lp2.gravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
        ...
        while (true) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    int vgrav = lp.gravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
                    if (hgrav == 1) {
