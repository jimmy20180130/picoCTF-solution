...
public final class ResourcesCompat {
    ...
    private static Typeface loadFont(@NonNull Context context, int id, TypedValue value, int style, @Nullable FontCallback fontCallback, @Nullable Handler handler, boolean isRequestFromLayoutInflator) throws Resources.NotFoundException {
    ...
    */
    private static android.graphics.Typeface loadFont(@androidx.annotation.NonNull android.content.Context r19, android.content.res.Resources r20, android.util.TypedValue r21, int r22, int r23, @androidx.annotation.Nullable androidx.core.content.res.ResourcesCompat.FontCallback r24, @androidx.annotation.Nullable android.os.Handler r25, boolean r26) throws android.content.res.Resources.NotFoundException {
        /*
