...
public class SwitchCompat extends CompoundButton {
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r10) throws java.lang.IllegalAccessException, java.lang.NoSuchMethodException, java.lang.SecurityException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
            r9 = this;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        int gravity = getGravity() & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (gravity == 16) {
