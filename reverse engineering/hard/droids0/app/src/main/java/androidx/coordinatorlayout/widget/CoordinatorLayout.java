...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public void setStatusBarBackground(@Nullable Drawable bg) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    public void setStatusBarBackgroundResource(@DrawableRes int resId) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        setStatusBarBackground(resId != 0 ? ContextCompat.getDrawable(getContext(), resId) : null);
    }

    public void setStatusBarBackgroundColor(@ColorInt int color) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
  ...
  0x0017: PHI (r3v1 'cancelSuper' boolean) = (r3v0 'cancelSuper' boolean), (r3v3 'cancelSuper' boolean) binds: [B:3:0x000e, B:5:0x0015] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
        ...
        while (i2 < childCount2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                if (b != null) {
                    ...
                    heightMode = heightMode2;
                    if (!b.onMeasureChild(this, child, heightUsed6, i3, childCount3, 0)) {
                    }
                ...
                widthUsed4 = Math.max(heightUsed2, heightPadding + widthUsed62 + lp.topMargin + lp.bottomMargin);
                int heightUsed72 = child.getMeasuredState();
                heightUsed4 = View.combineMeasuredStates(childState2, heightUsed72);
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View child, int layoutDirection, Rect anchorRect, Rect out, LayoutParams lp, int childWidth, int childHeight) {
        ...
        int vgrav = absGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
        int anchorHgrav = absAnchorGravity & 7;
        int anchorVgrav = absAnchorGravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay;
        if (anchorHgrav != 1) {
            if (anchorHgrav != 5) {
    ...
    private static int resolveGravity(int gravity) {
        ...
        if ((gravity & com.hellocmu.picoctf.R.styleable.AppCompatTheme_windowActionBarOverlay) == 0) {
            return gravity | 48;
        }
        return gravity;
    }
