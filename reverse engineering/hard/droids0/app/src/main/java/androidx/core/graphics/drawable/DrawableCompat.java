...
public final class DrawableCompat {
    ...
    public static boolean setLayoutDirection(@NonNull Drawable drawable, int layoutDirection) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 23) {
