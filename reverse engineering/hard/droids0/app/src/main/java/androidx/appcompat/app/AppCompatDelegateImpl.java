...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onConfigurationChanged(Configuration newConfig) throws IllegalAccessException, IllegalArgumentException {
        ActionBar ab;
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void onStart() throws IllegalAccessException, IllegalArgumentException {
        applyDayNight();
    }
    ...
    int updateStatusGuard(int insetTop) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public boolean applyDayNight() throws IllegalAccessException, IllegalArgumentException {
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void setLocalNightMode(int mode) throws IllegalAccessException, IllegalArgumentException {
    ...
    private boolean updateForNightMode(int mode) throws IllegalAccessException, IllegalArgumentException {
    ...
    private boolean shouldRecreateOnNightModeChange() throws PackageManager.NameNotFoundException {
        if (this.mApplyDayNightCalled) {
            Context context = this.mContext;
    ...
    final class AutoNightModeManager {
        ...
        void dispatchTimeChanged() throws IllegalAccessException, IllegalArgumentException {
