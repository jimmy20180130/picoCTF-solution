...
public abstract class ConstraintHelper extends View {
    ...
    public ConstraintHelper(Context context) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        super(context);
    ...
    public ConstraintHelper(Context context, AttributeSet attrs) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        super(context, attrs);
        this.mIds = new int[32];
        this.mUseViewMeasure = false;
        this.myContext = context;
    ...
    public ConstraintHelper(Context context, AttributeSet attrs, int defStyleAttr) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    protected void init(AttributeSet attrs) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        if (attrs != null) {
    ...
    private void addID(String idString) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
    ...
    private void setIds(String idList) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        if (idList == null) {
            return;
        }
        int begin = 0;
