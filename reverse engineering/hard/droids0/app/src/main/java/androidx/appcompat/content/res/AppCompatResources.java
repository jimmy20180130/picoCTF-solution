...
public final class AppCompatResources {
    ...
    public static ColorStateList getColorStateList(@NonNull Context context, @ColorRes int resId) throws Resources.NotFoundException {
    ...
    @Nullable
    private static ColorStateList inflateColorStateList(Context context, int resId) throws Resources.NotFoundException {
    ...
    private static boolean isColorInt(@NonNull Context context, @ColorRes int resId) throws Resources.NotFoundException {
        Resources r = context.getResources();
