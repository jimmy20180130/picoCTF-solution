...
class AppCompatPopupWindow extends PopupWindow {
    ...
    public AppCompatPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) throws IllegalAccessException, IllegalArgumentException {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    public AppCompatPopupWindow(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) throws IllegalAccessException, IllegalArgumentException {
