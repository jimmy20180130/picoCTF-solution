...
public final class AppCompatDrawableManager {
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int resId) throws Resources.NotFoundException {
    ...
    private Drawable loadDrawableFromDelegates(@NonNull Context context, @DrawableRes int resId) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int type;
