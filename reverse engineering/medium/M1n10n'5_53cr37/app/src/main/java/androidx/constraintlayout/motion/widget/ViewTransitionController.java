...
public class ViewTransitionController {
    ...
    private void listenForSharedVariable(ViewTransition viewTransition, boolean isSet) {
        ...
        ConstraintLayout.getSharedValues().addListener(viewTransition.getSharedValueID(), new SharedValues.SharedValuesListener() { // from class: androidx.constraintlayout.motion.widget.ViewTransitionController.1
            ...
            AnonymousClass1(ViewTransition viewTransition2, int listen_for_id2, boolean isSet2, int listen_for_value2) {
                val$viewTransition = viewTransition2;
                val$listen_for_id = listen_for_id2;
                val$isSet = isSet2;
                val$listen_for_value = listen_for_value2;
            }

            @Override // androidx.constraintlayout.widget.SharedValues.SharedValuesListener
            public void onNewValue(int id, int value, int oldValue) {
                int current_value = val$viewTransition.getSharedValueCurrent();
                val$viewTransition.setSharedValueCurrent(value);
                if (val$listen_for_id == id && current_value != value) {
                    if (val$isSet) {
                        if (val$listen_for_value == value) {
                            ...
                            for (int i = 0; i < count; i++) {
                                ...
                                if (val$viewTransition.matchesView(view)) {
                                    ...
                                    val$viewTransition.applyTransition(ViewTransitionController.this, ViewTransitionController.this.mMotionLayout, currentId, current, view);
                                }
                            }
                            return;
                        }
                    ...
                    if (val$listen_for_value != value) {
                        ...
                        for (int i2 = 0; i2 < count2; i2++) {
                            ...
                            if (val$viewTransition.matchesView(view2)) {
                                ...
                                val$viewTransition.applyTransition(ViewTransitionController.this, ViewTransitionController.this.mMotionLayout, currentId2, current2, view2);
                            }
                        }
                    }
                }
