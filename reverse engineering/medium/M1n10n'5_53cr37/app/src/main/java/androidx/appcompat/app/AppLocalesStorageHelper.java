...
class AppLocalesStorageHelper {
     ...
     */
    /* JADX WARN: Not initialized variable reg: 3, insn: 0x007f: IF  (r3 I:??[int, boolean, OBJECT, ARRAY, byte, short, char] A[D('fis' java.io.FileInputStream)]) == (0 ??[int, boolean, OBJECT, ARRAY, byte, short, char])  -> B:108:0x0086 (LINE:96), block:B:104:0x007f */
    /*
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:61:0x007a -> B:72:0x007c). Please report as a decompilation issue!!! */
