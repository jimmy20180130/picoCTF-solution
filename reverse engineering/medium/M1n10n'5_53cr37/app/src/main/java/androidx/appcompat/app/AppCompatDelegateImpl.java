...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        if (IS_PRE_LOLLIPOP && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.1
                ...
                AnonymousClass1(Thread.UncaughtExceptionHandler defHandler2) {
                    uncaughtExceptionHandler = defHandler2;
                }
                ...
                public void uncaughtException(Thread thread, Throwable throwable) {
                    if (shouldWrapException(throwable)) {
                        ...
                        uncaughtExceptionHandler.uncaughtException(thread, wrapped);
                        return;
                    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:21:0x0011 A[RETURN] */
    /*
