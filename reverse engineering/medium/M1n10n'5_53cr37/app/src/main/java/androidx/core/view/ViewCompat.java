...
public class ViewCompat {
    ...
    class AnonymousClass1 extends AccessibilityViewProperty<Boolean> {
        AnonymousClass1(int tagKey, Class cls, int frameworkMinimumSdk) {
    ...
    class AnonymousClass2 extends AccessibilityViewProperty<CharSequence> {
        AnonymousClass2(int tagKey, Class cls, int contentChangeType, int frameworkMinimumSdk) {
    ...
    class AnonymousClass3 extends AccessibilityViewProperty<CharSequence> {
        AnonymousClass3(int tagKey, Class cls, int contentChangeType, int frameworkMinimumSdk) {
            super(tagKey, cls, contentChangeType, frameworkMinimumSdk);
        }
    ...
    class AnonymousClass4 extends AccessibilityViewProperty<Boolean> {
        AnonymousClass4(int tagKey, Class cls, int frameworkMinimumSdk) {
            super(tagKey, cls, frameworkMinimumSdk);
        }
        ...
        static void setOnApplyWindowInsetsListener(View v, OnApplyWindowInsetsListener listener) {
            ...
            if (listener == null) {
                ...
                v.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: androidx.core.view.ViewCompat.Api21Impl.1
                    ...
                    AnonymousClass1(View v2, OnApplyWindowInsetsListener listener2) {
                        view = v2;
                        onApplyWindowInsetsListener = listener2;
                    }
                    ...
                    public WindowInsets onApplyWindowInsets(View view, WindowInsets insets) {
                        ...
                        if (Build.VERSION.SDK_INT < 30) {
                            Api21Impl.callCompatInsetAnimationCallback(insets, view);
                            if (compatInsets.equals(this.mLastInsets)) {
                                return onApplyWindowInsetsListener.onApplyWindowInsets(view, compatInsets).toWindowInsets();
                            }
                        }
                        this.mLastInsets = compatInsets;
                        WindowInsetsCompat compatInsets2 = onApplyWindowInsetsListener.onApplyWindowInsets(view, compatInsets);
                        if (Build.VERSION.SDK_INT >= 30) {
