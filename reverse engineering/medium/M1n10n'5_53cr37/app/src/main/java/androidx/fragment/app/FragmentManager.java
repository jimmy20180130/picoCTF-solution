...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    class AnonymousClass2 implements FragmentTransition.Callback {
        AnonymousClass2() {
        }
    ...
    public final void setFragmentResultListener(String requestKey, LifecycleOwner lifecycleOwner, FragmentResultListener listener) {
        ...
        LifecycleEventObserver observer = new LifecycleEventObserver() { // from class: androidx.fragment.app.FragmentManager.6
            ...
            AnonymousClass6(String requestKey2, FragmentResultListener listener2, Lifecycle lifecycle2) {
                str = requestKey2;
                fragmentResultListener = listener2;
            ...
            public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                Bundle storedResult;
                if (event == Lifecycle.Event.ON_START && (storedResult = (Bundle) FragmentManager.this.mResults.get(str)) != null) {
                    fragmentResultListener.onFragmentResult(str, storedResult);
        ...
        lifecycle2.addObserver(observer);
        LifecycleAwareResultListener storedListener = this.mResultListeners.put(requestKey2, new LifecycleAwareResultListener(lifecycle2, listener2, observer));
    ...
    */
    ...
    private void completeShowHideFragment(Fragment fragment) {
        ...
        if (fragment.mView != null) {
            ...
            if (anim != null && anim.animator != null) {
                ...
                if (fragment.mHidden) {
                    if (fragment.isHideReplaced()) {
                        ...
                        anim.animator.addListener(new AnimatorListenerAdapter() { // from class: androidx.fragment.app.FragmentManager.7
                            ...
                            AnonymousClass7(ViewGroup container2, View animatingView2, Fragment fragment2) {
                ...
                if (fragment2.mHidden && !fragment2.isHideReplaced()) {
                    visibility = 8;
                } else {
                    visibility = 0;
                }
        ...
        invalidateMenuForFragment(fragment2);
    ...
    void attachController(FragmentHostCallback<?> fragmentHostCallback, FragmentContainer container, Fragment parent) {
        ...
        if (this.mParent != null) {
            addFragmentOnAttachListener(new FragmentOnAttachListener() { // from class: androidx.fragment.app.FragmentManager.8
                ...
                AnonymousClass8(Fragment parent2) {
                    fragment = parent2;
                }
        ...
        if (fragmentHostCallback instanceof OnBackPressedDispatcherOwner) {
            ...
            LifecycleOwner owner = parent2 != null ? parent2 : onBackPressedDispatcherOwner;
            this.mOnBackPressedDispatcher.addCallback(owner, this.mOnBackPressedCallback);
        }
        if (parent2 != null) {
            this.mNonConfig = parent2.mFragmentManager.getChildNonConfig(parent2);
        ...
        if (this.mHost instanceof ActivityResultRegistryOwner) {
            ...
            String parentId = parent2 != null ? parent2.mWho + ":" : "";
    ...
    class AnonymousClass8 implements FragmentOnAttachListener {
        final /* synthetic */ Fragment val$parent;
    ...
    class AnonymousClass10 implements ActivityResultCallback<ActivityResult> {
        AnonymousClass10() {
        }
