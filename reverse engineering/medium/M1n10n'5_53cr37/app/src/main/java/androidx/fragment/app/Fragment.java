...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private static abstract class OnPreAttachedListener {
        ...
        /* synthetic */ OnPreAttachedListener(AnonymousClass1 x0) {
            this();
        }
    }
        ...
        if (FragmentManager.USE_STATE_MANAGER && this.mView != null && this.mContainer != null && this.mFragmentManager != null) {
            ...
            if (calledDirectly) {
                this.mHost.getHandler().post(new Runnable() { // from class: androidx.fragment.app.Fragment.3
                    ...
                    AnonymousClass3(SpecialEffectsController controller2) {
                        specialEffectsController = controller2;
                    }
                ...
                controller2.executePendingOperations();
            }
        }
    }
    ...
    public final <I, O> ActivityResultLauncher<I> registerForActivityResult(ActivityResultContract<I, O> contract, ActivityResultRegistry registry, ActivityResultCallback<O> callback) {
        return prepareCallInternal(contract, new Function<Void, ActivityResultRegistry>() { // from class: androidx.fragment.app.Fragment.7
            ...
            AnonymousClass7(ActivityResultRegistry registry2) {
                activityResultRegistry = registry2;
            }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(ActivityResultContract<I, O> contract, Function<Void, ActivityResultRegistry> registryProvider, ActivityResultCallback<O> callback) {
        ...
        AtomicReference<ActivityResultLauncher<I>> ref = new AtomicReference<>();
        registerOnPreAttachListener(new OnPreAttachedListener() { // from class: androidx.fragment.app.Fragment.8
            ...
            AnonymousClass8(Function registryProvider2, AtomicReference ref2, ActivityResultContract contract2, ActivityResultCallback callback2) {
                super();
                function = registryProvider2;
                atomicReference = ref2;
                activityResultContract = contract2;
                activityResultCallback = callback2;
            }

            @Override // androidx.fragment.app.Fragment.OnPreAttachedListener
            void onPreAttached() {
                String key = Fragment.this.generateActivityResultKey();
                ActivityResultRegistry registry = (ActivityResultRegistry) function.apply(null);
                atomicReference.set(registry.register(key, Fragment.this, activityResultContract, activityResultCallback));
            }
        });
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.9
            ...
            AnonymousClass9(AtomicReference ref2, ActivityResultContract contract2) {
                atomicReference = ref2;
                activityResultContract = contract2;
            }
            ...
            public void launch(I input, ActivityOptionsCompat options) {
                ActivityResultLauncher<I> delegate = (ActivityResultLauncher) atomicReference.get();
                if (delegate == null) {
            ...
            public void unregister() {
                ActivityResultLauncher<I> delegate = (ActivityResultLauncher) atomicReference.getAndSet(null);
                if (delegate != null) {
                    delegate.unregister();
                }
            }
