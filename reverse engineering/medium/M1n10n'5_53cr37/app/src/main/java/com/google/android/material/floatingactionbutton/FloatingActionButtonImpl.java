...
class FloatingActionButtonImpl {
    ...
    void hide(InternalVisibilityChangedListener listener, boolean fromUser) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            set.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.1
                ...
                AnonymousClass1(boolean fromUser2, InternalVisibilityChangedListener listener2) {
                    z = fromUser2;
                    internalVisibilityChangedListener = listener2;
                }
        ...
        this.view.internalSetVisibility(fromUser2 ? 8 : 4, fromUser2);
        if (listener2 != null) {
            listener2.onHidden();
        }
    }
    ...
    void show(InternalVisibilityChangedListener listener, boolean fromUser) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            set.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.2
                ...
                AnonymousClass2(boolean fromUser2, InternalVisibilityChangedListener listener2) {
                    z = fromUser2;
                    internalVisibilityChangedListener = listener2;
                }
        ...
        this.view.internalSetVisibility(0, fromUser2);
    ...
    private AnimatorSet createDefaultAnimator(float targetOpacity, float targetScale, float targetIconScale, int duration, int interpolator) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            AnonymousClass4(float startAlpha2, float targetOpacity2, float startScaleX2, float targetScale2, float startScaleY2, float startImageMatrixScale2, float targetIconScale2, Matrix matrix2) {
                f = startAlpha2;
                f = targetOpacity2;
                f = startScaleX2;
                f = targetScale2;
                f = startScaleY2;
                f = startImageMatrixScale2;
                f = targetIconScale2;
                matrix = matrix2;
            }
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                FloatingActionButtonImpl.this.view.setAlpha(AnimationUtils.lerp(f, f, 0.0f, 0.2f, progress));
                FloatingActionButtonImpl.this.view.setScaleX(AnimationUtils.lerp(f, f, progress));
                FloatingActionButtonImpl.this.view.setScaleY(AnimationUtils.lerp(f, f, progress));
                FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(f, f, progress);
                FloatingActionButtonImpl.this.calculateImageMatrixFromScale(AnimationUtils.lerp(f, f, progress), matrix);
