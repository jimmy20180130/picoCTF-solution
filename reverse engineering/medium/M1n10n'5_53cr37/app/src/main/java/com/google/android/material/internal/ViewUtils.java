...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(View view, AttributeSet attrs, int defStyleAttr, int defStyleRes, OnApplyWindowInsetsListener listener) {
        ...
        doOnApplyWindowInsets(view, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.internal.ViewUtils.1
            ...
            AnonymousClass1(boolean paddingBottomSystemWindowInsets2, boolean paddingLeftSystemWindowInsets2, boolean paddingRightSystemWindowInsets2, OnApplyWindowInsetsListener listener2) {
                z = paddingBottomSystemWindowInsets2;
                z = paddingLeftSystemWindowInsets2;
                z = paddingRightSystemWindowInsets2;
    ...
    public static void doOnApplyWindowInsets(View view, OnApplyWindowInsetsListener listener) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(view, new androidx.core.view.OnApplyWindowInsetsListener() { // from class: com.google.android.material.internal.ViewUtils.2
            ...
            AnonymousClass2(RelativePadding initialPadding2) {
                relativePadding = initialPadding2;
            }

            @Override // androidx.core.view.OnApplyWindowInsetsListener
            public WindowInsetsCompat onApplyWindowInsets(View view2, WindowInsetsCompat insets) {
                return onApplyWindowInsetsListener.onApplyWindowInsets(view2, insets, new RelativePadding(relativePadding));
            }
        });
