...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, T child, int offset, int duration) {
            ...
            if (this.offsetAnimator == null) {
                ...
                this.offsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.1
                    ...
                    AnonymousClass1(CoordinatorLayout coordinatorLayout2, AppBarLayout child2) {
                    ...
                    public void onAnimationUpdate(ValueAnimator animator) {
                        BaseBehavior.this.setHeaderTopBottomOffset(coordinatorLayout, appBarLayout, ((Integer) animator.getAnimatedValue()).intValue());
                    }
                });
            } else {
                this.offsetAnimator.cancel();
        ...
        private boolean addAccessibilityScrollActions(CoordinatorLayout coordinatorLayout, T appBarLayout, View scrollingView) {
            ...
            if (getTopBottomOffsetForScrollingSibling() != 0) {
                if (scrollingView.canScrollVertically(-1)) {
                    ...
                    if (dy != 0) {
                        ViewCompat.replaceAccessibilityAction(coordinatorLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.3
                            ...
                            AnonymousClass3(CoordinatorLayout coordinatorLayout2, AppBarLayout appBarLayout2, View scrollingView2, int dy2) {
                                coordinatorLayout = coordinatorLayout2;
                            ...
                            public boolean perform(View view, AccessibilityViewCommand.CommandArguments arguments) {
                                BaseBehavior.this.onNestedPreScroll(coordinatorLayout, (CoordinatorLayout) appBarLayout, view, 0, i, new int[]{0, 0}, 1);
                                return true;
                            }
                        });
                        return true;
                ...
                addActionToExpand(coordinatorLayout2, appBarLayout2, AccessibilityNodeInfoCompat.AccessibilityActionCompat.ACTION_SCROLL_BACKWARD, true);
                return true;
            }
            return a11yScrollable;
        }
        ...
        private void addActionToExpand(CoordinatorLayout parent, T appBarLayout, AccessibilityNodeInfoCompat.AccessibilityActionCompat action, boolean expand) {
            ViewCompat.replaceAccessibilityAction(parent, action, null, new AccessibilityViewCommand() { // from class: com.google.android.material.appbar.AppBarLayout.BaseBehavior.4
                ...
                AnonymousClass4(AppBarLayout appBarLayout2, boolean expand2) {
                    appBarLayout = appBarLayout2;
                    z = expand2;
                }
