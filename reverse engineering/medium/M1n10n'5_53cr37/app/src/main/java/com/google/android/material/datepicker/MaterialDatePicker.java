...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(headerLayout, new OnApplyWindowInsetsListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            ...
            AnonymousClass3(int originalHeaderHeight2, View headerLayout2, int originalPaddingTop2) {
                i = originalHeaderHeight2;
                view = headerLayout2;
                i = originalPaddingTop2;
            }
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                ...
                if (i >= 0) {
                    view.getLayoutParams().height = i + topInset;
                    view.setLayoutParams(view.getLayoutParams());
                }
                view.setPadding(view.getPaddingLeft(), i + topInset, view.getPaddingRight(), view.getPaddingBottom());
                return insets;
            }
        });
