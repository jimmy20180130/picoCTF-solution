...
class SearchBarAnimationHelper {
    ...
    private Animator getExpandAnimator(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout) {
    ...
    private Animator getCollapseAnimator(SearchBar searchBar, View expandedView, AppBarLayout appBarLayout) {
