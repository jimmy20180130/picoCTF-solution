...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    private final Object writeReplace() {
        ...
        fold(Unit.INSTANCE, new Function2<Unit, CoroutineContext.Element, Unit>() { // from class: kotlin.coroutines.CombinedContext.writeReplace.1
            ...
            C00361(CoroutineContext[] elements2, Ref.IntRef index2) {
                super(2);
                coroutineContextArr = elements2;
                intRef = index2;
            }
        ...
        return new Serialized(elements2);
    }
    ...
    /* renamed from: kotlin.coroutines.CombinedContext$writeReplace$1 */
    static final class C00361 extends Lambda implements Function2<Unit, CoroutineContext.Element, Unit> {
        final /* synthetic */ CoroutineContext[] $elements;
        final /* synthetic */ Ref.IntRef $index;
